...
#    path('new/success/',views.success, name = 'success'),
    path("create/", views.handleCourseForm, name='course'),
    path("create/course_created/", views.course_created, name = 'course_created'),
    path('new/', views.handleUserForm, name = 'resgister'),
